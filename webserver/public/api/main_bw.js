...
import easyrtc from './api/easyrtc_app'
...
function getRemoteStream(e){
	...
	for(var i=0;i<e.streams.length;i++)
	{
		...
		var remote_output = document.createElement('canvas');
		 var  context = remote_output.getContext('2d');          // Get rendering context
         // remote_output.width = 400;     // Set canvas width
         //remote_output.height = 400;    // Set canvas height
