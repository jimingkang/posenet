...
//import easyrtc from './api/easyrtc_lang';
//import easyrtc from './api/easyrtc';
 ...
 */
export function detectPoseInRealTime(video, net,output) {
	  const canvas =output;
 ...
 */
export async function bindPage(localVideo,output) {
  toggleLoadingUI(true);
